...
6. The URL contains `X-Plex-Token=...` → copy that value and paste it in your `.env` file.

---

## Disclaimer

> **Note on Transparency:** The modifications, UI/UX overhauls, and security architecture in this specific branch (`visualizer-rework`) were implemented with the assistance of a Large Language Model (LLM). This project is purely experimental and recreational.
